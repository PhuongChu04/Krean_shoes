...
<ul class="nav nav-pills mb-3 custom-pills">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('admin.blog_categories.trash') ? 'active' : '' }}"
            href="{{ route('admin.blog_categories.trash') }}">
                                    ...
                                    <tbody>
                                        @forelse ($categories as $category)
                                            <tr>
                                                ...
                                                <td>{{ $category->deleted_at ? $category->deleted_at->format('d/m/Y H:i') : '' }}
                                                </td>
                                                <td class="text-end">
                                                    <div class="dropdown">
                                                            ...
                                                            <li>
                                                                <form
                                                                    ...
                                                                    <button type="submit" class="dropdown-item">
                                                                        <i class="fa-solid fa-rotate-left me-1"></i> Khôi
                                                                        phục
                                                                    </button>
                                                                </form>
                                                            </li>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center text-muted">Không có danh mục nào
                                                    trong thùng rác.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
