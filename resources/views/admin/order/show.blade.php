                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                    ...
                                    <div class="row row-cols-xxl-5 row-cols-md-2 row-cols-1 mt-3 g-3">
                                        <div class="col">
                                            <div class="progress" style="height: 10px;">
                                                <div class="progress-bar bg-success progress-bar-striped progress-bar-animated"
                                                    role="progressbar"
                                                    style="width: {{ $order->status === 'pending' ? '100' : '100' }}%"
                                        ...
                                        <div class="col">
                                            <div class="progress" style="height: 10px;">
                                                <div class="progress-bar bg-success progress-bar-striped progress-bar-animated"
                                                    role="progressbar"
                                                    style="width: {{ in_array($order->status, ['confirmed', 'processing', 'shipped', 'delivered']) ? '100' : '0' }}%">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col">
                                            <div class="progress" style="height: 10px;">
                                                <div class="progress-bar bg-{{ $order->status === 'processing' ? 'warning' : 'primary' }} progress-bar-striped progress-bar-animated"
                                                    role="progressbar"
                                                    style="width: {{ $order->status === 'processing' ? '60' : ($order->status === 'shipped' || $order->status === 'delivered' ? '100' : '0') }}%">
                                                </div>
                                            </div>
                                            <p
                                                class="mb-0 mt-2 text-center {{ $order->status === 'processing' ? 'text-warning' : '' }}">
                                                Xử lý</p>
                                        </div>
                                        <div class="col">
                                            <div class="progress" style="height: 10px;">
                                                <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated"
                                                    role="progressbar"
                                                    style="width: {{ $order->status === 'shipped' || $order->status === 'delivered' ? '100' : '0' }}%">
                                                </div>
                                            </div>
                            ...
                            <div
                                class="card-footer d-flex flex-wrap align-items-center justify-content-between bg-light-subtle gap-3">
                                <p class="border rounded mb-0 px-3 py-2 bg-body">
                                    <i class='bx bx-calendar-check align-middle fs-16'></i>
                                    Ngày giao dự kiến: <span
                                        class="text-dark fw-medium">{{ $order->estimated_delivery ?? 'Chưa xác định' }}</span>
                                </p>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle mb-0 table-hover table-centered">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="text-center py-4">Không có sản phẩm trong đơn
                                                        hàng.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <div class="position-relative ms-2">
                                    <span class="position-absolute start-0 top-0 border border-dashed h-100"
                                        ...
                                        <div class="position-relative ps-4 mb-4">
                                            <span
                                                ...
                                                <iconify-icon icon="solar:check-circle-bold-duotone"
                                                    class="fs-20 text-success"></iconify-icon>
                                            </span>
                                            <div class="ms-2">
                                                <h5 class="mb-1 text-dark fw-medium fs-15">
                                                    {{ $history->to_status ?? 'Trạng thái cập nhật' }}</h5>
                                                <p class="mb-0 text-muted">Cập nhật bởi:
                                                    {{ $history->changed_by ?? 'Admin' }}</p>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    </script> © Krean Admin. All rights reserved.
                </div>
            </div>
        </div>
    </footer>
