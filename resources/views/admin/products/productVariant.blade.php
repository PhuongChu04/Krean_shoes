                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.products.show', $variant->product_id) }}"
                            class="btn btn-secondary btn-sm">Quay lại chi tiết sản phẩm</a>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control bg-light"
                                                value="{{ $variant->size->name }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control bg-light"
                                                value="{{ $variant->color->name }}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @forelse($variant->images as $image)
                                        <div class="col-3 position-relative">
                                            ...
                                            <div class="form-check position-absolute top-0 end-0 m-1">
                                                ...
                                                <label
                                                    class="form-check-label text-white bg-danger px-1 rounded small">Xóa</label>
                                            </div>
                                        </div>
                                    @empty
