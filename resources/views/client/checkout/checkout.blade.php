                ...
                <div class='row'>
                    <div class='col-lg-12'>
                        <div class='cr-breadcrumb-title'>
                            <h2>Thanh toán</h2>
                            <span> <a href='{{ route('client.homeClient') }}'>Trang chủ</a> / <a
                                    href='{{ route('cart.view') }}'>Giỏ hàng</a> / Thanh toán</span>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class='cr-product-inner d-flex align-items-center'>
                                                <div class='cr-pro-image-outer me-2'>
                                                    <div class='cr-pro-image'>
                                                        <a href='/san-pham/{{ $item->productVariant->product->slug }}'
                                                            class='image'>
                                                            <img height='80px' class='main-image'
                                                ...
                                                <div class='cr-pro-content cr-product-details'>
                                                    <h5 class='cr-pro-title'><a
                                                            href='/san-pham/{{ $item->productVariant->product->slug }}'>{{ $item->productVariant->product->name }}{{ $item->productVariant->attribute_name ? ' (' . $item->productVariant->attribute_name . ')' : '' }}</a>
                                                    </h5>
                                                    <p class='cr-price mb-0'>
                                                        <span
                                                            class='new-price'>{{ number_format($item->productVariant->price, 0, ',', '.') }}
                                                            ₫</span>
                            ...
                            <div class='cr-sb-block-content'>
                                <div class='cr-checkout-pay'>
                                    ...
                                    <div class='cr-pay-option'>
                                        <label class='d-block'><input type='radio' name='payment_method' value='cod'
                                                checked> Thanh toán khi nhận hàng (COD)</label>
                                        <label class='d-block'><input type='radio' name='payment_method' value='bank'>
                                ...
                                <div class='cr-checkout-block cr-check-bill'>
                                    ...
                                    <div class='cr-bl-block-content'>
                                        <div class='cr-check-bill-form mb-minus-24'>
                                            <form id='checkout-form' action='{{ route('client.checkout.process') }}'
                                                method='POST'>
                                                @csrf
                                                @if ($type === 'selected')
                                                ...
                                                <div class='row'>
                                                    ...
                                                    <div class='col-md-12 mb-2'>
                                                        ...
                                                        <select class='form-control' id='city' name='city' required>
                                                            ...
                                                            <option value='Hồ Chí Minh'
                                                                {{ old('city') == 'Hồ Chí Minh' ? 'selected' : '' }}>Hồ Chí
                                                                Minh</option>
                                                            <option value='Hà Nội'
                                                                {{ old('city') == 'Hà Nội' ? 'selected' : '' }}>Hà Nội
                                                            </option>
                                                            <option value='Đà Nẵng'
                                                                {{ old('city') == 'Đà Nẵng' ? 'selected' : '' }}>Đà Nẵng
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class='col-md-6 mb-2'>
                                                        ...
                                                        <select class='form-control' id='district' name='district'
                                                            ...
                                                            <option value='Quận 1'
                                                                {{ old('district') == 'Quận 1' ? 'selected' : '' }}>Quận 1
                                                            </option>
                                                            <option value='Quận 3'
                                                                {{ old('district') == 'Quận 3' ? 'selected' : '' }}>Quận 3
                                                            </option>
                                                            <option value='Quận 10'
                                                                {{ old('district') == 'Quận 10' ? 'selected' : '' }}>Quận
                                                                10</option>
                                                        </select>
                                                    </div>
                                                    <div class='col-md-6 mb-2'>
                                                        ...
                                                        <select class='form-control' id='ward' name='ward'
                                                            ...
                                                            <option value='Phường 1'
                                                                {{ old('ward') == 'Phường 1' ? 'selected' : '' }}>Phường 1
                                                            </option>
                                                            <option value='Phường 2'
                                                                {{ old('ward') == 'Phường 2' ? 'selected' : '' }}>Phường 2
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class='col-md-12 mb-2'>
                                                ...
                                                <div class='cr-checkout-btn mt-3'>
                                                    <button type='submit' class='cr-button btn btn-success w-100'><i
                                                            class='ri-shopping-bag-line'></i> Đặt hàng</button>
                                                    <a href='{{ route('cart.view') }}'
                                                        class='cr-links mt-3 d-block text-center'><i
                                                            class='ri-arrow-left-line'></i> Quay lại giỏ hàng</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class='cr-checkout-block mt-3'>
                                    ...
                                    <div class='cr-checkout-block-content'>
                                        <div class='cr-checkout-summary'>
                                            <div class='cr-checkout-row'><span>Tạm
                                                    tính</span><span>{{ number_format($subtotal, 0, ',', '.') }} ₫</span>
                                            </div>
                                            <div class='cr-checkout-row'><span>Phí vận
                                                    chuyển</span><span>{{ number_format($shipping, 0, ',', '.') }} ₫</span>
                                            </div>
                                            @if (isset($discount) && $discount > 0)
                                                <div class='cr-checkout-row'><span>Giảm
                                                        giá</span><span>-{{ number_format($discount, 0, ',', '.') }}
                                                        ₫</span></div>
                                            @endif
                                            <div class='cr-checkout-row cr-checkout-total'><span>Tổng
                                                    cộng</span><span>{{ number_format($total, 0, ',', '.') }} ₫</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
