...
<style>
    {{-- Enhanced Chat Bot Styles - Version 2.0 --}}
    ...
    .chat-info-panel .info-header p {
        margin: 0;
        font-size: 12px;
        color: #617a60;
    }

    .chat-info-panel .close-info-btn {
        border: none;
    ...
    .chat-info-panel .close-info-btn:hover {
    ...
    .chat-info-panel .info-item i {
        font-size: 18px;
        color: #4caf50;
    }

    .chat-info-panel .info-actions {
        display: flex;
        gap: 10px;
        flex-wrap: wrap;
    }

    .chat-info-panel .info-action-btn {
        flex: 1;
        min-width: 120px;
        background: #4caf50;
        color: white;
    ...
    .chat-info-panel .info-action-btn:hover {
        background: #3d8b3d;
        transform: translateY(-1px);
    }

    .chat-info-panel .info-action-btn.secondary {
        background: #eef7ee;
        color: #2f4f2f;
    }

    .chat-info-panel .info-action-btn.secondary:hover {
        background: #d6ead4;
    }
            ...
            <div class="message-box bot welcome-message">
                ...
                <div class="message-content">
                    ...
                    <div class="quick-replies">
                        ...
                        <button onclick="sendQuickReply('Tư vấn về sản phẩm giày')" class="quick-reply-btn">
                            💡 Tư vấn sản phẩm
                        </button>
...
<script>
    ...
    function toggleChatbot() {
        const isInfoOpen = chatInfoPanel.classList.contains('show');
        if (isInfoOpen) {
            chatInfoPanel.classList.remove('show');
            chatInfoPanel.setAttribute('aria-hidden', 'true');
            chatToggleButton.style.display = 'flex';
        } else {
            chatInfoPanel.classList.add('show');
            chatInfoPanel.setAttribute('aria-hidden', 'false');
    ...
    function appendProducts(products) {
        ...
        productsContainer.style.cssText =
            'opacity: 0; transform: translateY(20px); transition: all 0.4s ease; display: block !important; margin-top: 10px;';
    ...
    function handleKeyboardShortcuts(e) {
        ...
        // ESC để đóng thông tin
        if (e.key === 'Escape' && chatInfoPanel.classList.contains('show')) {
            toggleChatbot();
        }
    }
    ...
    document.addEventListener('visibilitychange', function() {
        if (!document.hidden && chatInfoPanel.classList.contains('show')) {
            userInput.focus();
        }
    });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Focus input if info panel is open
        if (chatInfoPanel.classList.contains('show')) {
            userInput.focus();
        }
