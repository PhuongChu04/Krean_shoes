        ...
        <div class="footer-contact">
            <ul class="footer-info">
                ...
                <li class="item">
                    ...
                    <a target="_blank" 
                       href="https://www.google.com/maps?q={{ urlencode($webInfos['address'] ?? '') }}">
                        {{ $webInfos['address'] ?? 'Chưa cập nhật địa chỉ' }}
                    </a>
                </li>
