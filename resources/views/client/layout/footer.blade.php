        ...
        <div class="container">
            ...
            <div class="footer-col-block s1">
                ...
                <div class="tf-collapse-content">
                    <div class="footer-contact d-flex align-items-center justify-content-between flex-wrap gap-4">
                        <ul class="footer-info d-flex align-items-center gap-5 mb-0 list-unstyled">
                        ...
                        <a href="https://www.google.com/maps?q={{ urlencode($webInfos['address'] ?? '') }}"
                            target="_blank" class="tf-btn btn-line-dark fw-normal">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-wrap">
                <p class="text-dark">Copyright © 202y by <span class="fw-medium">KREAN.</span> Chất lượng tạo thương
                    hiệu.</p>
