        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.dropdown-menu .select-item').forEach(item => {
                item.addEventListener('click', function() {
                    document.querySelector('.text-sort-value').innerText = this.querySelector('.text-value-item').innerText;
                    currentSort = this.dataset.sortValue;
                    
                    document.querySelectorAll('.dropdown-menu .select-item').forEach(el => el.classList.remove('active'));
            ...
            function fetchFilteredProducts() {
                let brands = Array.from(document.querySelectorAll('input[name="brand"]:checked')).map(el => el.value);
                let availability = document.querySelector('input[name="availability"]:checked')?.value || '';
                let colors = Array.from(document.querySelectorAll('.color-check.active')).map(el => el.dataset.colorId);
                let sizes = Array.from(document.querySelectorAll('.size-check.active')).map(el => el.dataset.sizeId);
